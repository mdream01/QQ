...
<%-- 						<c:forEach var="a" begin="1" end="5">
						...
						<%-- <c:forEach var="n" items="${list}" begin="3" end="4"> --%>
						<c:forEach var="n" items="${list}"  varStatus="s">
							<tr>
								<td class="seq">${n.code}</td>
								<td class="title">${s.index}:<a href="noticeDetail.jsp?c=${n.code}">${n.title}</a>
								[
								<span style="color:red;">${n.cmtCnt}</span>
								]
								</td>
								<td class="writer">${n.title}</td>
					...
					<p>
						<c:forTokens var="n" items="20,35,2,4,5" delims=",">
							${n+1}/
						</c:forTokens>
					</p>
					...
					<div id="pager-wrapper" class="margin-small">
						<div class="pager clear">
							...
							<ul>
								...
								<li>
									<a href="notice?f=${param.f}&q=${param.q}&pg=2">2</a>
								</li>
								<li>
									<a href="notice?f=${param.f}&q=${param.q}&pg=3">3</a>
								</li>
								<li>
									<a href="notice?f=${param.f}&q=${param.q}&pg=4">4</a>
								</li>
								<li>
									<a href="notice?f=${param.f}&q=${param.q}&pg=5">5</a>
								</li>
							</ul>
							<p id="btnNext">
